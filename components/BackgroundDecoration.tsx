...
export default function BackgroundDecoration() {
  return (
    <>
      ...
      ></div>
      <div className="fixed z-20 top-[140px] w-full overflow-hidden font-gothic text-[100px] leading-none">
      ...
      <div className="z-2 fixed inset-0 w-full h-full pointer-events-none visible translate-z-0">
        <div className="grid grid-cols-[1fr_375px_1fr] h-screen overflow-hidden sticky top-0 w-full">
          <div className="relative">
            <div className="flex absolute inset-0 items-center flex-col justify-center m-auto h-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="absolute translate-x-[-100px] translate-y-[216px] ">
                <SpriteAnimation category={"bg01"} className="w-[min(calc(174_/_1440_*_100vw),174px)]" />
              </div>
              <div className="absolute translate-x-[120px] translate-y-[216px] ">
                <SpriteAnimation category={"bg02"} className="w-[min(calc(174_/_1440_*_100vw),174px)]" />
              </div>
              <Image
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="absolute translate-x-[-120px] translate-y-[100px] ">
                <SpriteAnimation category={"bg03"} className="w-[min(calc(240_/_1440_*_100vw),240px)]" />
              </div>
              <div className="absolute translate-x-[120px] translate-y-[206px] ">
                <SpriteAnimation category={"bg04"} className="w-[min(calc(180_/_1440_*_100vw),180px)]" />
              </div>
              {/* <Image width={60} height={77} src="/kettlebell.png" alt="走るキャラクター" /> */}
            </div>
          </div>
        </div>
      </div>
